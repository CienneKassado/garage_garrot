  ...
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <div class="d-flex flex-wrap justify-content-center">
        ...
        <button type="button" class="btn btn-primary btn-lg custom-btn m-2" onclick="window.location.href='modification_voitures_employe.php'">Nos véhicules d'occasions</button>
    ...
    <div class="col-md-6 commentaires">
      ...
      <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <?php
          // Diviser les commentaires en groupes de 3
